...
public class dregister extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		link="dreg.jsp?temp="+email+"&temp1="+username+"&temp2="+password;
		...
		try {
			...
			ResultSet rs;
			int i=st.executeUpdate("insert into doctor(dname,password,sex,contact,speciality,email)values('"+username+"','"+password+"','"+sex+"','"+contact+"','"+speciality+"','"+email+"');");
			if(i>0)
			{
