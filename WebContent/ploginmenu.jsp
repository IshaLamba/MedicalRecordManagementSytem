...
<title>Patient Login Menu</title>
<link rel="stylesheet" type="text/css" href="mystylesheet.css"/>
</head>
<body>
<div class="image"></div>
<div id="menu">
<a href="pprofile.jsp">Show Profile</a><br>
<a href="pchoosedoctor.jsp">Submit Query</a><br>
<a href="pquerystatus.jsp">Query Status</a><br>
<a href="appointment.jsp">Take Appointment</a><br>
