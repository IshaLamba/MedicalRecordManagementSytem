...
String mail="Hi '"+str1+"'. \n Thanks for taking your time to register with us.\n\nYour username is: '"+str1+"' and password is: '"+str2+"'";
try
{
...
<%
	...
	p.println("\n\n\nAn email has been sent to your email address regarding your account details.");
%>
</body>
</html>